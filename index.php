    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-7">
            <p>It is almost impossible to believe what technology has achieved so far. Starting with the microphone invention in the 19th century, reaching to Smartphones and Virtual reality nowadays. We really made a huge leap! Our real concern here, in "The Replicator", is the next level of great technologies that really impacted our lives.One of which is 3D printing...using Alexa!You can access stored models and 3D print them with the use of a raspberry pi. 
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="speaker text-left">
              <a href="speaker-single.html" class="d-block mb-3 thumbnail"><img src="images/person_1.jpg" alt="Image" class="img-fluid"></a>
              <h3 class="heading mb-0"><a href="#"><span>Will</span> Peters</a></h3>
              <p>Business Consultant in Google</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4">
            <div class="speaker text-left">
              <a href="speaker-single.html" class="d-block mb-3 thumbnail"><img src="images/person_2.jpg" alt="Image" class="img-fluid"></a>
              <h3 class="heading mb-0"><a href="#"><span>Abigail</span> McMillan</a></h3>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-lg-4">
            <div class="text-center p-4 item">
              ...
              <h2 class="h5 text-uppercase">The file you upload must have an .stl extension</h2>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati reprehenderit explicabo quos fugit vitae dolorum.</p>
            </div>
          </div>
          ...
          <div class="col-md-4 col-lg-4">
            <div class="text-center p-4 item">
              ...
              <h2 class="h5 text-uppercase">The file you upload must not be already in the database</h2>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati reprehenderit explicabo quos fugit vitae dolorum.</p>
            </div>
          </div>
